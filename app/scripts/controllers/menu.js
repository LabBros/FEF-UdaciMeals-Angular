...
angular.module('udaciMealsAngularApp')
  .controller('MenuCtrl', function () {
    this.items = {
      salads: [
	{
	  id: 'salmon-couscous-and-arugula-salad',
	  name: 'Salmon Couscous & Arugula Salad',
	  img: 'salmon-couscous-and-arugula-salad.jpg',
	  url: 'https://www.eatclub.com/s/dish/Salmon-Couscous/'
	},
	{
	...
	{
	  id: 'pear-and-goat-cheese-salad',
	  name: 'Pear and Goat Cheese Salad',
	  img: 'pear-and-goat-cheese-salad.jpg',
	  url: 'https://www.eatclub.com/s/dish/Pear-Goat-Cheese/'
	}
      ],
      sandwiches: [
	{
	...
	},
	{
	  ...
	  name: 'The Big Pig',
	  img: 'the-big-pig.jpg',
	  url: 'https://www.eatclub.com/s/dish/the-big-pig/'
	},
	{
	  id: 'very-veggie',
	  name: 'Very Veggie',
	  img: 'very-veggie.jpg',
	  url: 'https://www.eatclub.com/s/dish/very-veggie-ingrained/'
	}
      ],
      mainMeals: [
	{
	  ...
	  url: 'https://www.eatclub.com/s/dish/BBQ-Pork-Combo/'
	},
	{
	  id: 'the-cali-trio',
	  name: 'The Cali Trio',
	...
	},
	{
      ...
      desserts: [
	{
	  id: 'double-layer-pumpkin-cheesecake',
	  name: 'Double Layer Pumpkin Cheesecake',
	  img: 'double-layer-pumpkin-cheesecake.jpg',
	  url: 'http://allrecipes.com/recipe/13477/double-layer-pumpkin-cheesecake/'
	},
	{
	  id: 'creamy-rice-pudding',
	  name: 'Creamy Rice Pudding',
	  img: 'creamy-rice-pudding.jpg',
	  url: 'http://allrecipes.com/recipe/24059/creamy-rice-pudding/'
	},
	{
	...
	{
	  id: 'mocha-candy-bar',
	  name: 'Mocha Candy Bar',
	  img: 'mocha-candy-bar.png',
	  url: 'https://www.eatclub.com/snacks/catalog/'
	},
	{
	...
	{
	  id: 'simply-sweet-potato-tortilla-chips',
	  name: 'Simply Sweet Potato Tortilla Chips',
	  img: 'simply-sweet-potato-tortilla-chips.png',
	  url: 'https://www.eatclub.com/snacks/catalog/'
	}
      ]
    };
